...
WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:KxZcY47uGp9a...       \t-> pDckmggQM...\n' +
                 'p2wpkh-p2sh:KxZcY47uGp9a... \t-> PNhNeZQXF...\n' +
                 'p2wpkh:KxZcY47uGp9a...      \t-> pkt1q3fjfk...')
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.setWindowTitle('PKT Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('PKT Electrum wallet'))
